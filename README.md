...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/django-tables2-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12921&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/django-tables2-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `django-tables2` can be installed with:

```
conda install django-tables2
```

It is possible to list all of the versions of `django-tables2` available on your platform with:
